...
public class generate {
    ...
    public static void main(String[] args) throws IOException {
        ...
        defineAst(outputDir, "stmt", Arrays.asList(
                ...
                "var        : token* name, expr& initializer, visibility vis, bool isfinal",
                ...
                "class_decl : token* name, vector<function_stmt*>& methods, vector<constructor_stmt*>& constructors, vector<var_stmt*> variables, visibility vis",
                "null       : token* where"

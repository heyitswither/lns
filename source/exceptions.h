...
#define FATAL_ERROR_S   (lns::no_format ? ( "\n" FATAL_ERROR_UNFORMATTED) : ( "\n" FATAL_ERROR_FORMATTED))
#define PARSE_ERROR_S   (lns::no_format ? ( "\n" PARSE_ERROR_UNFORMATTED) : ( "\n" PARSE_ERROR_FORMATTED))
#define RUNTIME_ERROR_S (lns::no_format ? ( "\n" RUNTIME_ERROR_UNFORMATTED) : ( "\n" RUNTIME_ERROR_FORMATTED))

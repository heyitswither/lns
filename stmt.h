...
namespace lns {
    ...
    public:
        function_stmt(token &name, vector<token> &parameters, vector<stmt *> &body, bool isglobal) : name(name),
                                                                                                     parameters(
                                                                                                             parameters),
                                                                                                     body(body),
                                                                                                     isglobal(
    ...
    public:
        if_stmt(expr &condition, stmt *thenBranch, stmt *elseBranch) : condition(condition), thenBranch(thenBranch),
    ...
    public:
        var_stmt(token &name, expr &initializer, bool isglobal, bool isfinal) : name(name), initializer(initializer),
                                                                                isglobal(isglobal), isfinal(isfinal) {}
